...
public class Student {
    ...
    public int DajBrojIndeksa() {
        return brojIndeksa.PrebaciUInteger();
    }
    ...
    public void PromijeniBrojIndeksa(int broj) {
        this.brojIndeksa = new IntWrapper(broj);
    }
    ...
    public boolean IstiStudent(Student s) {
        if (this.DajIme().equals(s.DajIme()) && this.DajPrezime().equals(s.DajPrezime()) && this.DajBrojIndeksa() == s.DajBrojIndeksa())
            return true;
        return false;
    }
